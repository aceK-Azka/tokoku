...
if(isset($_POST["newposttitle"])){
	...
	$shopid = mysqli_real_escape_string($connection, $_POST["tokoid"]);
	...
	if($newposttitle != "" && $newpostcontent != ""){
		...
		mysqli_query($connection, "INSERT INTO $tableposts (postid, catid, tokoid, title, content, picture, time, normalprice, discountprice, options, moreimages) VALUES ('$postid', $catid, $shopid, '$newposttitle', '$newpostcontent', '$newpicture', '$currenttime', '$normalprice', '$discountprice', '$moreoptions', '$moreimages')");
