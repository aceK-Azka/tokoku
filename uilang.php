...
*/
    ...
    function translateId(){
		...
		$definitions = array(
			...
			"Please add shop first" => "Tambah toko dahulu",
			...
			"Enter new name for category" => "Nama baru untuk kategori",
			"Enter new name for shop" => "Nama baru untuk toko",
			"Enter new WhatsApp number" => "Nomor WhatsApp baru",
			...
			"Language" => "Bahasa",
			"Leave blank if unnecessary" => "Boleh tidak diisi jika tidak perlu",
			...
			"New shop has been added" => "Toko baru telah ditambahkan",
			"New shop" => "Toko baru",
			"New WhatsApp Number" => "Nomor WhatsApp baru",
			...
			"No shop has been added" => "Belum ada toko yang sudah ditambahkan",
			"No" => "Tidak",
			"Notes" => "Catatan",
			"Nothing found" => "Tidak ditemukan apapun",
			"Oh no..." => "Oh tidak...",
			"One category removed" => "Satu kategori telah dihapus",
			"One shop removed" => "Satu toko telah dihapus",
			...
			"Shop" => "Toko",
			"Shop Name" => "Nama Toko",
			"Shop updated" => "Toko telah diperbarui",
			...
			"This field must be filled out" => "Kolom ini wajib diisi",
			"Title" => "Judul",
			"Total" => "Total Semua",
