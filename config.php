...
/*
Langkah 1: Buat database, dan catat nama database Anda
Langkah 2: Buat pengguna basis data dan tetapkan pengguna itu ke basis data itu, catat nama pengguna dan kata sandi
Langkah 3: Sesuaikan informasi koneksi database pada file dbcon.php sesuai dengan catatan Anda sebelumnya
Langkah 4: Sesuaikan nama pengguna dan kata sandi Panel Admin sesuai keinginan
Langkah 5: Jalankan web, dua kali untuk pertama kalinya, dan login ke Panel Admin Anda dengan mengakses halaman admin.php
*/

//Admin panel user dan password
$username = "admin";
$password = "admin";
...
//Creating tables - toko
mysqli_query($connection, "CREATE TABLE IF NOT EXISTS $tableshop (
id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
nama VARCHAR(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
nomor_wa VARCHAR(15) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
)");
